...
export type AutoMentorSettingsFragment = Pick<AutoMentorSettings, 'allow' | 'disabledRewardIds' | 'reserveResourceRewardsForOtherTasks'>;
...
export type AutoBuildSettingsFragment = (
  Pick<AutoBuildSettings, 'allow' | 'autoCropFields' | 'minCrop'>
...
export const MoveQueuedBuildingDownDocument: DocumentNode = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveQueuedBuildingDown"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"QueuedBuildingManipulationInput"}}},"directives":[]}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveQueuedBuildingDown"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"directives":[]}]}}]};
export type MoveQueuedBuildingDownMutationFn = ApolloReactCommon.MutationFunction<MoveQueuedBuildingDownMutation, MoveQueuedBuildingDownMutationVariables>;

/**
 * __useMoveQueuedBuildingDownMutation__
 *
 * To run a mutation, you first call `useMoveQueuedBuildingDownMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useMoveQueuedBuildingDownMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [moveQueuedBuildingDownMutation, { data, loading, error }] = useMoveQueuedBuildingDownMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useMoveQueuedBuildingDownMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<MoveQueuedBuildingDownMutation, MoveQueuedBuildingDownMutationVariables>) {
        return ApolloReactHooks.useMutation<MoveQueuedBuildingDownMutation, MoveQueuedBuildingDownMutationVariables>(MoveQueuedBuildingDownDocument, baseOptions);
      }
export type MoveQueuedBuildingDownMutationHookResult = ReturnType<typeof useMoveQueuedBuildingDownMutation>;
export type MoveQueuedBuildingDownMutationResult = ApolloReactCommon.MutationResult<MoveQueuedBuildingDownMutation>;
export type MoveQueuedBuildingDownMutationOptions = ApolloReactCommon.BaseMutationOptions<MoveQueuedBuildingDownMutation, MoveQueuedBuildingDownMutationVariables>;
export const MoveQueuedBuildingUpDocument: DocumentNode = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveQueuedBuildingUp"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"QueuedBuildingManipulationInput"}}},"directives":[]}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveQueuedBuildingUp"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"directives":[]}]}}]};
export type MoveQueuedBuildingUpMutationFn = ApolloReactCommon.MutationFunction<MoveQueuedBuildingUpMutation, MoveQueuedBuildingUpMutationVariables>;

/**
 * __useMoveQueuedBuildingUpMutation__
 *
 * To run a mutation, you first call `useMoveQueuedBuildingUpMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useMoveQueuedBuildingUpMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [moveQueuedBuildingUpMutation, { data, loading, error }] = useMoveQueuedBuildingUpMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useMoveQueuedBuildingUpMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<MoveQueuedBuildingUpMutation, MoveQueuedBuildingUpMutationVariables>) {
        return ApolloReactHooks.useMutation<MoveQueuedBuildingUpMutation, MoveQueuedBuildingUpMutationVariables>(MoveQueuedBuildingUpDocument, baseOptions);
      }
export type MoveQueuedBuildingUpMutationHookResult = ReturnType<typeof useMoveQueuedBuildingUpMutation>;
export type MoveQueuedBuildingUpMutationResult = ApolloReactCommon.MutationResult<MoveQueuedBuildingUpMutation>;
export type MoveQueuedBuildingUpMutationOptions = ApolloReactCommon.BaseMutationOptions<MoveQueuedBuildingUpMutation, MoveQueuedBuildingUpMutationVariables>;
